...
interface Build {
  ...
  creator_name: string; views: number;
}
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <Link href="/dashboard" className="inline-flex items-center justify-center bg-[#0F172A] text-white font-medium text-sm px-6 py-2.5 rounded-lg hover:bg-[#1E293B] transition-colors">
                Create a build
              </Link>
            </div>
          ) : (
