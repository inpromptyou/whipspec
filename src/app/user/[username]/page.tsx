...
async function getProfile(raw: string): Promise<{ user: UserProfile; builds: Build[] } | null> {
  // Strip @ prefix if present — supports /user/@username and /user/username
      ...
      <main className="pt-24 pb-20 min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center py-8 sm:py-12">
            {/* Avatar */}
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-br from-[#1E6DF0] to-[#3B82F6] mx-auto mb-4 flex items-center justify-center text-white text-3xl sm:text-4xl font-semibold shadow-lg shadow-[#1E6DF0]/20 overflow-hidden">
              {user.avatar_url ? (
